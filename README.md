...
directory does a lot of that for you. You would run it like so:
    ...
    go install github.com/chanced/oapi-codegen/cmd/oapi-codegen@latest
...
import (
	...
	"github.com/chanced/oapi-codegen/examples/petstore-expanded/gin/api"
	middleware "github.com/chanced/oapi-codegen/pkg/gin-middleware"
)
...
```go
    import (
        "github.com/chanced/oapi-codegen/pkg/securityprovider"
    )
...
[`/internal/test/externalref/`](https://github.com/chanced/oapi-codegen/blob/master/internal/test/externalref/externalref.cfg.yaml)
...
output-options:
  skip-prune: true
import-mapping:
  ./packageA/spec.yaml: github.com/chanced/oapi-codegen/internal/test/externalref/packageA
  ./packageB/spec.yaml: github.com/chanced/oapi-codegen/internal/test/externalref/packageB
output: externalref.gen.go
output-options:
  skip-prune: true
```

Have a look at [`cmd/oapi-codegen/oapi-codegen.go`](https://github.com/chanced/oapi-codegen/blob/master/cmd/oapi-codegen/oapi-codegen.go#L48)
